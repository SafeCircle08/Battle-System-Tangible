...
if (image_angle % 90 == 0) && (rotDelay == 0) { 
	if (confirmPressed()) dpShoot(irandom_range(10, 25));
...
if (confirmPressed() && !oDrumPadScope.canShoot) { audio_play_sound(sndEmptyChamber, 50, false); exit; }

if (!oDrumPadScope.canShoot) { exit; }
if (confirmPressed()) dpShoot(0);