function propertyesOfEnchantments() {
	...
	global.enchantPoisonFree = setUpPropertyInfos(ENCHANT_POISON_FREE[ENCHANT_SPRITE], "Removes Poison Tag", sPoisonFreeEnchDet, _toAddList, true);
	global.enchantSlownessFree = setUpPropertyInfos(ENCHANT_SLOWNESS_FREE[ENCHANT_SPRITE], "Returns to ogirinal Speed", sRemoveSlownessEnchDet, _toAddList, true);
}