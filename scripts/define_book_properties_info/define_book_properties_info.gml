...
global.propertyOfEnchantments = [
	...
	setUpPropertyInfos(ENCHANT_POISON_FREE[ENCHANT_SPRITE], "Removes Poison Tag", sGoldyEnchDetailed, true),
	setUpPropertyInfos(ENCHANT_SLOWNESS_FREE[ENCHANT_SPRITE], "Returns to ogirinal Speed", sGoldyEnchDetailed, true)
];
